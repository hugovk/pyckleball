...
def case_deregister():
    print(f"ATTEMPT: Case_deregister.py is removing the registrant from the session on {case_day_my_session_string}....")
    ...
    print(f"SUCCESS: Registrant was removed from session on {case_day_my_session_string}.")
