...
def case_register():
    print(f"ATTEMPT: Case_register.py.....Registering registrant user for the session on {case_day_my_session_string}.")
    ...
    page.pause()
    print(f"SUCCESS: Case_register.py.....Registrant signed up for the session on {case_day_my_session_string}.")
